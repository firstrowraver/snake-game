...
export class Sound {
  ...
  private beep(frequency: number, duration: number, volume: number = 0.15): void {
    try {
...
export class Music {
  ...
  private static BPM = 160;
  private static EIGHTH = 60 / Music.BPM / 2; // ~0.1875s

  // Upbeat melody — original composition, game-like pentatonic feel
  private static MELODY: MusicNote[] = [
